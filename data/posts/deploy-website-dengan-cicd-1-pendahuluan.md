...
Bismillah. <!-- excerpt -->Pada seri tutorial ini, akan dibahas bagaimana cara deploy dengan CI/CD menggunakan tools Github Actions dan Vercel. Karena di tutorial ini<!-- excerpt --> hanya akan berfokus pada cara deployment dan penerapan simpel dari CI seperti menjalankan pengujuan kode secara otomatis setiap ada perubahan kode, dsb. Maka saya sudah menyiapkan website yang bisa didownload [disini](https://github.com/rezafikkri/counter-js/archive/refs/tags/for-download.zip), website tersebut hanyalah website *counter* biasa, dengan sedikit modifikasi dan tambahan unit testing serta linting. Pada seri ke-1 ini akan dibahas mengenai beberapa teori terkait dan juga upload website ke remote repositori di Github.
...
- Github Actions adalah platform CI/CD yang memungkinkan kamu untuk mengotomatiskan alur build, test dan deployment, baca [disini](https://docs.github.com/en/actions/learn-github-actions/understanding-github-actions) untuk mengetahui lebih lanjut tentang Github Action.
...
<ol>
  ...
  <li>Buat public remote repositori baru pada akun Github-mu, isi <strong>Repository name</strong>, <strong>Decription</strong> (optional) dan klik <strong>Create repository</strong> serta biarkan value yang lain default saja, seperti di bawah ini: <img alt="before create new repo" src="/posts/deploy-vercel-github-action/before-create-new-repo.png" width="1336" height="1224" loading="lazy" class="mt-6" decoding="async"/></li>
  <li>Lalu pastikan setelah kamu klik <strong>Create repository</strong>, maka akan diarahkan ke halaman seperti di bawah ini, yang menandakan repositori masih kosong: <img alt="after create new repo" src="/posts/deploy-vercel-github-action/after-create-new-repo.png" width="1336" height="656" loading="lazy" class="mt-6" decoding="async"/></li>
  <li>
    Kemudian buka kembali terminal atau cmd pada direktori utama website counte-js dan tambahkan remote repository dengan nama "origin" (kamu bisa menggunakan <em>ssh</em> atau <em>https</em>):
...
git remote add origin https://github.com/[username]/[remote-repo-name].git
  ...
  <li>
    Dan lakukan push sekaligus <em>set upstream branch</em>:
    <pre><code class="language-bash">git push -u origin main</code></pre>
  </li>
  <li>Terakhir, pastikan website counter-js berhasil terupload ke Github (dengan merefresh halaman yang tampil pada langkah ke-3).</li>
</ol>
