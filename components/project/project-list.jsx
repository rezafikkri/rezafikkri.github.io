  ...
  return (
    <>
      ...
      <div className="border border-gray-300 bg-white rounded-lg px-5 pt-4 pb-12 relative">
        ...
        <div className="absolute bottom-4">
          <Link href="https://github.com/rezafikkri/Manport" className="inline-block no-underline border border-gray-200 bg-gray-50 hover:bg-gray-100 rounded-lg px-2 py-1 text-sm mr-2">Code</Link>
        </div>
      </div>
      ...
      <div className="border border-gray-300 bg-white rounded-lg px-5 pt-4 pb-12 relative">
        ...
        <div className="absolute bottom-4">
          <Link href="https://github.com/rezafikkri/School-website" className="inline-block no-underline border border-gray-200 bg-gray-50 hover:bg-gray-100 rounded-lg px-2 py-1 text-sm mr-2">Code</Link>
        </div>
      </div>
      ...
      <div className="border border-gray-300 bg-white rounded-lg px-5 pt-4 pb-12 relative">
        ...
        <div className="absolute bottom-4">
          <Link href="https://github.com/rezafikkri/Nvim-R" className="inline-block no-underline border border-gray-200 bg-gray-50 hover:bg-gray-100 rounded-lg px-2 py-1 text-sm mr-2">Code</Link>
        </div>
      </div>
    </>
  );
