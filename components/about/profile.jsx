  ...
  return (
    <section className="mt-12">
      ...
      <div className="flex gap-2 mt-5">
        <Link href="https://github.com/rezafikkri" rel="noopener noreferrer" target="_blank" className="border-2 border-gray-500 hover:border-ajwa-blue rounded-lg px-2.5 py-1.5">
        ...
        <Link href="https://twitter.com/fikkrireza" rel="noopener noreferrer" target="_blank" className="border-2 border-gray-500 hover:border-ajwa-blue rounded-lg px-2.5 py-1.5">
        ...
        <Link href="https://www.linkedin.com/in/reza-sariful-fikri/" rel="noopener noreferrer" target="_blank" className="border-2 border-gray-500 hover:border-ajwa-blue rounded-lg px-2.5 py-1.5">
        ...
        <Link href="https://web.facebook.com/reza.sariful.fikri" rel="noopener noreferrer" target="_blank" className="border-2 border-gray-500 hover:border-ajwa-blue rounded-lg px-2.5 py-1.5">
        ...
        <Link href="https://youtube.com/@rezafikkri" rel="noopener noreferrer" target="_blank" className="border-2 border-gray-500 hover:border-ajwa-blue rounded-lg px-2.5 py-1.5">
